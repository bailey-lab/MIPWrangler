...
MIPWrangler mipClusteringMultiple                       --masterDir $(realpath ./)  --par /home/hathawan/hathaway/MIPWrangler/etc/clusteringPars/illumina.pars.txt--numThreads $2 --overWriteDirs --overWriteLog --logFile mipClustering_run1 
MIPWrangler mipPopulationClusteringMultiple             --masterDir $(realpath ./)  --numThreads $2 --overWriteDirs --overWriteLog --logFile mipPopClustering_run1 
