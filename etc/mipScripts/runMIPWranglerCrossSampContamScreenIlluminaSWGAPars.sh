...
MIPWrangler mipClusteringMultiple                       --masterDir $(realpath ./)  --numThreads $2 --overWriteDirs --overWriteLog --logFile mipClustering_run1 --par /home/hathawan/hathaway/MIPWrangler/etc/clusteringPars/illumina_swga.pars.txt
