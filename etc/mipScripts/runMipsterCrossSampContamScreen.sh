...
mipster mipCorrectForContamWithSameBarcodesMultiple --masterDir $(realpath ./)  --numThreads $2 --overWriteDirs --overWriteLog --logFile mipCorrectForContamWithSameBarcodes_run1
...
nohup mipster mav			                        --masterDir $(realpath ./)  --numThreads $2 --port 1000$1 --name mip$1  &
