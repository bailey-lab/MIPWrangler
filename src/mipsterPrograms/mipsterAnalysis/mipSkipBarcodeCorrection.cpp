...
int mipsterAnalysisRunner::mipSkipBarcodeCorrection(const bib::progutils::CmdArgs & inputCommands){
...
int mipsterAnalysisRunner::mipSkipBarcodeCorrectionMultiple(const bib::progutils::CmdArgs & inputCommands){
	mipsterAnalysisSetUp setUp(inputCommands);
